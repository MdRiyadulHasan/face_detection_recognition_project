...
# The codes given below is used to  detect the face of an unknown images during inference.
            ...
            try:
                ...
                if status:
                    ...
                    if cstatus:          
                        ...
                        return True                     # if face detection is possible then return true
            except:
                print('For ', image_name ,'face detection is not possible')
                return False
